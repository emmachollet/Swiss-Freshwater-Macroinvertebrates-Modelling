...
ann.outputs <- lapply(list.hyper.param, FUN = build_and_train_model, Xtrain, Ytrain, Xtest, lr, ne, bs)

file.name <- paste0(dir.models.output, "output_ANN_07_12.rds")
